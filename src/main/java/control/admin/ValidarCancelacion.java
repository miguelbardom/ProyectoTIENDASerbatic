...
/**
 * Servlet implementation class ValidarCancelacion
 */
@WebServlet("/validarCancelacion")
public class ValidarCancelacion extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ValidarCancelacion() {
        super();
